...
def Lean.Elab.Term.elabTermAndSynthesizeEnsuringType (stx : Syntax) (expectedType? : Option Expr) (errorMsgHeader? : Option String := none) : TermElabM Expr := do
...
private def Lean.Expr.mkArrayAux (ty : Expr) (as : List Expr) : MetaM Expr :=
do match as with 
